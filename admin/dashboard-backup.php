...
<div class="metrics-grid">
        ...
        <div class="metric-content">
            ...
            <div class="metric-sub">
                <a href="heatmap-analytics.php" class="metric-link">
                    <i class="fas fa-fire"></i> Ver Analytics Avanzados
                </a>
            </div>
        </div>
    </div>
    ...
    <!-- Suppliers Status -->
    <div class="metric-card suppliers-card">
        ...
        <div class="metric-content">
            ...
            <span class="metric-trend positive">Todos conectados</span>
            <div class="metric-sub">
    ...
    <div class="dashboard-sections">
        ...
        <div class="dashboard-section quick-actions-section">
            ...
            <div class="quick-actions-grid">
                <a href="inventory-management.php" class="quick-action-card inventory">
                ...
                <a href="order-management.php" class="quick-action-card orders">
                    <div class="action-icon">
                ...
                <a href="production-workflow.php" class="quick-action-card production">
                    <div class="action-icon">
                    ...
                    <div class="action-content">
                        ...
                        <span class="action-badge success">5 en proceso</span>
                    </div>
                </a>
                
                <a href="manage-users.php" class="quick-action-card users">
                    <div class="action-icon">
                ...
                <a href="heatmap-analytics.php" class="quick-action-card analytics">
                    <div class="action-icon">
                    ...
                    <div class="action-content">
                        ...
                        <span class="action-badge info">Tiempo real</span>
                    </div>
                </a>
                
                <a href="supplier-management.php" class="quick-action-card suppliers">
                    <div class="action-icon">
                    ...
                    <div class="action-content">
                        ...
                        <span class="action-badge success"><?php echo $stats['active_suppliers']; ?> conectados</span>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="dashboard-section users-section">
            <div class="section-header">
                ...
                <div class="section-actions">
                    <a href="manage-users.php" class="btn btn-sm btn-secondary">
                        <i class="fas fa-cog"></i> Gestionar
                    </a>
                </div>
            </div>
        ...
        <!-- Top Products Table -->
        <div class="dashboard-section products-table-section">
            <div class="section-header">
                <h3><i class="fas fa-medal"></i> Productos Más Vendidos</h3>
                <div class="section-actions">
                    <a href="manage-products.php" class="btn btn-sm btn-secondary">
                    ...
                    <tbody>
                        <?php foreach ($top_products as $index => $product): ?>
                            <tr>
                                ...
                                <td><span class="badge badge-info"><?php echo $product['sales']; ?> unidades</span></td>
                                <td><strong>$<?php echo number_format($product['revenue'], 2); ?></strong></td>
                                <td><span class="trend positive"><i class="fas fa-arrow-up"></i> 12%</span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
        ...
        <?php if (!empty($recent_posts) || !empty($pending_comments)): ?>
        <div class="dashboard-section content-section">
            <div class="section-header">
                <h3><i class="fas fa-edit"></i> Gestión de Contenido</h3>
            </div>
            
            <div class="content-tabs">
                <div class="tab-buttons">
                    <button class="tab-btn active" data-tab="posts">Posts Recientes</button>
                    <?php if (!empty($pending_comments)): ?>
                    <button class="tab-btn" data-tab="comments">Comentarios Pendientes (<?php echo count($pending_comments); ?>)</button>
                    <?php endif; ?>
                </div>
                            ...
                            <?php foreach ($recent_posts as $post): ?>
                                <div class="post-item">
                                    ...
                                    <div class="post-actions">
                                        <a href="../edit-post.php?id=<?php echo $post['id']; ?>" class="btn btn-sm btn-outline">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="manage-posts.php" class="btn btn-sm btn-secondary">
                                            <i class="fas fa-cog"></i> Gestionar
                                        </a>
                                    </div>
                                </div>
                        ...
                        <?php foreach ($pending_comments as $comment): ?>
                            <div class="comment-item">
                                ...
                                <div class="comment-actions">
                                    <a href="manage-comments.php?approve=<?php echo $comment['id']; ?>" class="btn btn-sm btn-success">
                                        <i class="fas fa-check"></i> Aprobar
                                    </a>
                                    <a href="manage-comments.php?reject=<?php echo $comment['id']; ?>" class="btn btn-sm btn-danger">
...
.quick-action-card.inventory .action-icon { background: linear-gradient(135deg, #28a745, #20c997); }
.quick-action-card.orders .action-icon { background: linear-gradient(135deg, #007bff, #6f42c1); }
.quick-action-card.production .action-icon { background: linear-gradient(135deg, #fd7e14, #e83e8c); }
.quick-action-card.users .action-icon { background: linear-gradient(135deg, #6f42c1, #e83e8c); }
.quick-action-card.analytics .action-icon { background: linear-gradient(135deg, #17a2b8, #20c997); }
.quick-action-card.suppliers .action-icon { background: linear-gradient(135deg, #6c757d, #495057); }
...
function updateDashboard() {
    ...
    setTimeout(() => {
        AdminUtils.showNotification('Dashboard actualizado correctamente', 'success');
    }, 1500);
}
...
function refreshActivity() {
    AdminUtils.showNotification('Actualizando actividad reciente...', 'info');
    
    // Simulate activity refresh
    setTimeout(() => {
        AdminUtils.showNotification('Actividad actualizada', 'success');
    }, 1000);
}
